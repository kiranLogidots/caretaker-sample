...
import { getColumns } from '@/app/shared/transport-coordinator/users-table/columns';
import { listClusterCreation, listTC } from '@/service/page';
import { signOut } from 'next-auth/react';
const FilterElement = dynamic(
  () => import('@/app/shared/transport-coordinator/users-table/filter-element'),
  { ssr: false }
);
...
export default function UsersTable({ data = [] }: { data: any[] }) {
  ...
  console.log(' transport-coordinator TABLE DATA', tableData);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const resultData =
          (await listTC()) as ClusterCreationResponse;
        console.log('TC result data', resultData);
