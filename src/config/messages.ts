export const messages = {
  ...
  invalidEmail: 'Invalid email address, Enter the correct email address',
  invalidPassword: 'Incorrect Password, Enter the correct password',
  ...
  organizationIdRequired: 'Select your organization',
  ...
  locationaddressIsRequired: 'Location Address is required',
  ...
  onboardedByIsRequired: 'Required field',
  primaryLocationIsRequired: 'Required field',
  organizationIdIsRequired: 'Required field',
  organizationBranchIdIsRequired: 'Required field',
  primaryPositionIdIsRequired: 'Required field',
