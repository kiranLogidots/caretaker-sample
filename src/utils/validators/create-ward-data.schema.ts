...
export const wardDataFormSchema = z.object({
  ...
  house_not_intrested: z.string().min(1, { message: messages.houeNoInterest }),
  house_w_no_money: z.string().min(1, { message: messages.houseNoMoney }),

  collection_amt: z
    .string()
    .min(1, { message: messages.collectionAmountIsReq }),
  ...
  shops_with_no_interest: z
    .string()
    .min(1, { message: messages.shopsNoInterest }),
